package com.lumina_bank.aiassistantservice.application.assistant.profile;

import com.lumina_bank.aiassistantservice.infrastructure.external.user.dto.Address;
...
public class BusinessUserUpdateProcessor {
    ...
    public BusinessUserUpdateRequest merge(
            BusinessUserResponse current,
            Map<String, Object> params
    ) {
        ...
        return new BusinessUserUpdateRequest(
