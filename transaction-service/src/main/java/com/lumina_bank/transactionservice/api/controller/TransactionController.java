package com.lumina_bank.transactionservice.api.controller;

import com.lumina_bank.transactionservice.api.request.TransactionCreateRequest;
import com.lumina_bank.transactionservice.api.response.TransactionResponse;
import com.lumina_bank.transactionservice.domain.model.Transaction;
import com.lumina_bank.transactionservice.application.service.TransactionService;
...
public class TransactionController {
    ...
    public ResponseEntity<?> makeTransaction(@Valid @RequestBody TransactionCreateRequest request) {
        ...
        return ResponseEntity.created(URI.create("/transactions/"))
                .body(new TransactionResponse(outTransactionId, inTransactionId));
